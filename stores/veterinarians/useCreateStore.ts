...
export const useCreateStore = defineStore("veterinarians-create", {
	state: () => {
	...
	actions: {
		...
		async create(): Promise<void> {
			...
			if (formData.get("permissions_can_access_castromovel")) {
				formData.set("permissions[]", "can_access_castromovel");
			}

			if (formData.get("permissions_can_apply_vaccine")) {
				formData.set("permissions[]", "can_apply_vaccine");
			}
