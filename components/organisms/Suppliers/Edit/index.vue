...
export default defineComponent({
    ...
    async setup() {
        ...
        useSuppliersEdit.setFormField("business_name", supplier?.business_name || "");
        useSuppliersEdit.setFormField("municipal_registration", supplier?.municipal_registration || "");
        useSuppliersEdit.setFormField("state_registration", supplier?.state_registration || "");
        useSuppliersEdit.setFormField("representative", supplier?.representative || "");
                    ...
                    <div class="citizens__input-data__content">
                        <div class="citizens__input-data__content--group">
                            ...
                            <MoleculesInputCommon
                                ...
                                @on-input="useSuppliersEdit.setFormField('business_name', $event)"
                            />
                        </div>
                        <div class="citizens__input-data__content--group">
                            <MoleculesInputCommon
                                ...
                                :message-error="form.municipal_registration.errorMessages.join(', ')"
                                @on-input="useSuppliersEdit.setFormField('municipal_registration', $event)"
                            />
                            <MoleculesInputCommon
                                ...
                                :message-error="form.state_registration.errorMessages.join(', ')"
                                @on-input="useSuppliersEdit.setFormField('state_registration', $event)"
                            />
                            <MoleculesInputCommon
                                label="Representante"
                                max-width="50%"
                                ...
                                @on-input="useSuppliersEdit.setFormField('representative', $event)"
                            />
                        </div>
                    </div>
                </div>
