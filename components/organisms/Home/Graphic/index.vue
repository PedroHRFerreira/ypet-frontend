...
export default defineComponent({
  ...
  setup() {
    ...
    const changePeriod = (selected: IOption) => {
      ...
      // Lógica para atualizar o gráfico com base no período selecionado
    };

    const labels = ref(["Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho"]);
...
.wrapper-graphic {
  ...
  border-radius: 6px;
  background: var(--white, linear-gradient(0deg, rgba(255, 255, 255, 0.20) 0%, rgba(255, 255, 255, 0.20) 100%), #FFF);
